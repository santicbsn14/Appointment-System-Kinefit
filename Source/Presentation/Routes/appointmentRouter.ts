...
appointmentRouter.post('/bypatient', authMiddleware, authorization('CreateAppointmentsByPatient'), createAppointmentByPatient)
...
appointmentRouter.delete('/:id',authMiddleware, authorization('DeleteAppointments'), deleteOne)
