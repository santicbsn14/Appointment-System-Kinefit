...
import { createScheduledSessions, deleteOne, getAll, getById, update } from "../Controllers/scheduledSessionsController";

const scheduledSessionsRouter: Router = Router()
