...
import { ScheduledSessions } from 'Source/Data/Models/scheduledSessionsSchema';


describe('ScheduledSessionsMongooseRepository', () => {
    let repository: ScheduledSessionsMongooseRepository;
    let testScheduledSessionsId: mongoose.Types.ObjectId;
    ...
    it('should create a new scheduledSessions', async () => {
      const scheduledSessionsData: ScheduledSessions = { pacient_id: new mongoose.Types.ObjectId(),
